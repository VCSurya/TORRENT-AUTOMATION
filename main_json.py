...
SAP_API['InvoiceDate'] = JSON['data']['InvoiceDate']
SAP_API['InvoiceAmount'] = JSON['data']['InvoiceAmount']
SAP_API['PoLpoIoNoPdf'] = JSON['data']['PoNo']
